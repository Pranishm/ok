...
# cursor.execute(
#     '''INSERT INTO info VALUES ('pranish', 'IT Student', '7620464305', 'pranish6139@gmail','india')''')
# connection.commit()
...
# updatePersonalInfo('pranish', 'IT Student', '9488056003',
#                    'pranish6139@gmail.com', 'india')
